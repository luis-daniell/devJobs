        ...
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border-2 shadow-md">
                ...
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form method="POST" class="py-10 px-5" action="{{ route('password.email') }}" novalidate>
                        @csrf


                        @if (session('status'))
                            <span class="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 w-full my-2 text-sm block " role="alert">
